		...
		<div class="col-sm-6<?php if(empty($conf['daiguaurl'])){?> hide<?php }?>">
            <a href="./?mod=daigua" class="widget">
                <div class="widget-content themed-background-success text-right clearfix" style="color: #fff;">
                    ...
                    <div class="col-sm-6">
                        <a href="http://huzan.58nimai.com/" target="_blank" class="widget">
...
<div class="block">
	...
	<!--网站日志-->
	 ...
	 <p>
            友情合作：  
            <a href="http://www.8866.plus/">免费互赞平台</a>
             | 
            <a href="http://www.adminaaa.club/">免费防红短链接</a>
             | 
            <a href="http://www.79vps.cn/">高防虚拟主机</a>
...
<script src="https://cdn.xiaoc.eu.org/copy.js"></script>
